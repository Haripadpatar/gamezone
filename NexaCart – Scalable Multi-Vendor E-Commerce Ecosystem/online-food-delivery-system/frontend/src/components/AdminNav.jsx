...
import { BarChart3, ShoppingBag, PlusCircle, Settings, ClipboardList, Home, Store, Users } from 'lucide-react';

const AdminNav = () => {
  const links = [
    { to: "/admin/dashboard", label: "Stats Dashboard", icon: BarChart3 },
    { to: "/admin/orders", label: "Manage Orders", icon: ClipboardList },
    { to: "/admin/products", label: "Manage Products", icon: PlusCircle },
    { to: "/admin/categories", label: "Categories", icon: ShoppingBag },
    { to: "/admin/restaurants", label: "Manage Restaurants", icon: Store },
    { to: "/admin/merchants", label: "Manage Merchants", icon: Users },
    ...
    <div className="w-full flex flex-col gap-4 border-b border-slate-900 pb-2">
      ...
      <div className="flex justify-between items-center px-2">
        <div className="text-left">
          <span className="text-[10px] text-rose-500 font-extrabold uppercase tracking-wider">Merchant Portal</span>
          <h2 className="text-xl font-black text-white">Store Administration</h2>
        </div>
